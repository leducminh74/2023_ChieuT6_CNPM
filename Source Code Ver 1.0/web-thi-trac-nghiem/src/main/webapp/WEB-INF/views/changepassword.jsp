        ...
        <div class="container">
            ...
            <div class="signin-content">
                ...
                <div class="signin-form">
                    ...
                    <form method="post" class="login-form" id="change-password-form" action="change-password">
                        <div class="input-line">
                            <div class="form-group">
                                <label ><i class="fas fa-lock material-icons-name"></i></label>
                                <input type="password" name="currentPassword" id="current-password" class="styled-input" placeholder="Your Current Password"/>
                            </div>
                        ...
                        <div class="input-line">
                            <div class="form-group">
                                ...
                                <input type="password" name="newPassword" id="new-password" class="styled-input" placeholder="Your New Password"/>
                            </div>
                            <span class="form-message"></span>
                        </div>
                        <div class="input-line">
                            <div class="form-group">
                                <label ><i class="fas fa-lock"></i></label>
                                <input type="password" name="renewPassword" id="re-newpassword" class="styled-input" placeholder="Repeat New Password"/>
                            </div>
                            <span class="form-message"></span>
                        </div>
