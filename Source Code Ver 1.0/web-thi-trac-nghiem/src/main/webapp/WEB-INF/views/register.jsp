				...
				<div class="signup-content">
					<div class="signup-form">
						...
						<form:form method="post" class="register-form" id="register-form"
							action="register" modelAttribute="account">
							...
							<div class="input-line">
								<div class="form-group">
									...
									<form:input path="password" type="password" name="Password"
										id="password" class="styled-input" placeholder="Your Password" />
								</div>
								<span class="form-message"></span>
							</div>
							<div class="input-line">
								<div class="form-group">
									<label><i class="fas fa-lock"></i></label> <input
										type="password" name="Re_password" id="re_password"
										class="styled-input" placeholder="Repeat your password" />
								</div>
								<span class="form-message"></span>
							</div>
							...
							<div class="form-group">
								<input style="width: auto; display: inline-block"
									type="checkbox" name="agree-term" id="agree-term"
									class="agree-term" required /> <label for="agree-term"
									class="label-agree-term">I agree all statements in <a
